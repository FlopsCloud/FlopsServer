...
func (m *defaultRolePermissionsModel) Insert(ctx context.Context, data *RolePermissions) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.RoleId, data.PermissionId, data.GrantedAt, data.GrantedBy)
	return ret, err
}
...
func (m *defaultRolePermissionsModel) Update(ctx context.Context, data *RolePermissions) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.RoleId, data.PermissionId, data.GrantedAt, data.GrantedBy, data.Id)
	return err
}
