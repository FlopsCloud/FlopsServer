...
type ListResourceOrgDiscountLogic struct {
	logx.Logger
	ctx    context.Context
...
// 用户获取组织资源折扣
func NewListResourceOrgDiscountLogic(ctx context.Context, svcCtx *svc.ServiceContext) *ListResourceOrgDiscountLogic {
	return &ListResourceOrgDiscountLogic{
...
func (l *ListResourceOrgDiscountLogic) ListResourceOrgDiscount(req *types.ListResourceOrgDiscountRequest) (resp *types.AdminListResourceOrgDiscountResponse, err error) {
	...
	err = l.svcCtx.Mysql.QueryRowsCtx(l.ctx, &resourceOrgDiscount, sql, req.OrgId)
	if err != nil {
		return nil, err
	}
